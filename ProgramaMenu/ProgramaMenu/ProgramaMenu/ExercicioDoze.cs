...
namespace ProgramaMenu
{
    internal class ExercicioDoze
    {
        public static void Executar()
        {
            ...
            {
                avaliacao_final = "A - Parabéns, vocês está Aprovado";
            }
            else
            {
                if (media_aproveitamento >= 75 && media_aproveitamento < 90)
                {
                    avaliacao_final = "B - Parabéns, vocês está Aprovado";
                }
                else
                {
                    if (media_aproveitamento >= 60 && media_aproveitamento < 75)
                    {
                        avaliacao_final = "C - Parabéns, vocês está Aprovado";
                    }
                    else
                    {
